    ...
    items: [
      {
        id: "terms-of-service",
        title: "Terms",
        description: "These Terms of Service (the “Terms”) are a legal agreement between you and NOTT. By using or accessing the Services, you agree to be bound by these Terms. If you are using the Services on behalf of an organization, you are agreeing to these Terms for that organization and promising that you have the authority to bind that organization to these Terms. In that case, “you” and “your” will refer to that organization.",
      },
    ],
  },
];
