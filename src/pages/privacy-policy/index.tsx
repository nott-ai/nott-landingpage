  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.contentContainer}>
        ...
        <div className={style.content}>
          <p className={style.title}>{`1. Collecting information`}</p>
          <p className={style.description}>
            {`
        ...
        <div className={style.content}>
          <p className={style.title}>{`2. Processing of information`}</p>
          <p className={style.description}>
        ...
        <div className={style.content}>
          <p className={style.title}>{`3. Legal basis`}</p>
        ...
        <div className={style.content}>
          <p className={style.title}>{`4. Sharing personal information`}</p>
          <p
            className={style.description}
            dangerouslySetInnerHTML={createMarkup(
              getHighlightedText(
        ...
        <div className={style.content}>
          <p className={style.title}>{`5. Cookies & tracking technologies`}</p>
          <p className={style.description}>
        ...
        <div className={style.content}>
          <p className={style.title}>{`6. Storing personal information`}</p>
          <p className={style.description}>
        ...
        <div className={style.content}>
          <p className={style.title}>{`7. Sharing data with others`}</p>
          <p className={style.description}>
        ...
        <div className={style.content}>
          <p className={style.title}>{`8. Users’ right with their own data`}</p>
        ...
        <div className={style.content}>
          <p className={style.title}>{`9. Updates and Notice`}</p>
          <p className={style.description}>
