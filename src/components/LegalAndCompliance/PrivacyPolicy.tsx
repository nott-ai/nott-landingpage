          ...
          <div className={style.contentContainer}>
              ...
              <div className={style.content}>
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={createMarkup(
                    `${getHighlightedText("Basic Information:")}`
                  )}
                />
                <ul>
                  <li>{`Name`}</li>
            ...
            ${getHighlightedText(
              ...
              <div className={style.content}>
                ...
                <ul>
                  <li
                    dangerouslySetInnerHTML={createMarkup(`<span style="font-weight: 600; color: #0F244C">To facilitate account creation and authentication and otherwise manage user accounts.</span> 
                  ...
                  <li
                    ...
                    )} In accordance with the General Data Protection Regulation (GDPR), NOTT is committed to the lawful, fair, and transparent processing of personal health data of our users. 
                    The collection, processing, and use of personal health data are conducted with the sole purpose of analyzing health indicators and providing users with valuable health-related 
                    information and insights, all aimed at benefiting the user's health and well-being. 
                    The processing of personal health data is based on explicit consent obtained from the users. 
                    Users have the right to withdraw their consent at any time without affecting the lawfulness of processing based on consent before its withdrawal.
              ...
              We may process your information when necessary to request feedback and to contact you about your use of our Services.
                `)}
                  />
                  <li
                    dangerouslySetInnerHTML={createMarkup(`<span style="font-weight: 600; color: #0F244C">To send you marketing and promotional communications.</span> 
                    We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time.
                     <span style="font-weight: 600; color: #0F244C">To deliver targeted advertising to you.</span> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more.
                     <span style="font-weight: 600; color: #0F244C">To save or protect an individual's vital interest.</span> We may process your information when necessary to save or protect an individual’s vital interest, such as to prevent harm.
                     `)}
                  />
                </ul>
              </div>
            ...
            litigation in which we are involved.`)}
                ...
                <p
                  className={style.description}
                  dangerouslySetInnerHTML={createMarkup(`
            ${getHighlightedText("Vital Interests:")} We may process 
...
`}
              ...
              <div className={style.content}>
                ...
                <p className={style.description}>
                  ...
                  No purpose in this notice will require us to keep your personal information for longer than the period of 
...
`}
              ...
              <div className={style.content}>
                ...
                <p className={style.description}>
                  ...
                  transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, 
...
`}
              ...
              <div className={style.content}>
                ...
                <p className={style.description}>
                  ...
                  implementing dnt signals has been finalized. As such, we do not currently respond to dnt browser signals or any other 
                  mechanism that automatically communicates your choice not to be tracked online. If a standard for online tracking 
...
`}
              ...
              <div className={style.content}>
                ...
                <p className={style.description}>
                  ...
                  such as for undertaking internal research for technological development and analysis for users’ goodness. 
                  This is not considered to be "selling" of  your personal information.`}
                </p>
                <p className={style.description}>
                  {`NOTT has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. 
                  NOTT not sell personal information in the future belonging to website visitors, users, and other consumers.
`}
                </p>
              </div>
              ...
              <div className={style.content}>
                ...
                <p className={style.description}>
                  ...
                  For instance, depending on the type of request you submit, we may ask you to provide certain information so that we can match 
                ...
                <p className={style.description}>
                  ...
                  we will avoid requesting additional information from you for the purposes of verification. 
