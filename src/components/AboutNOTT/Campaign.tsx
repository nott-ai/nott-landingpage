    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        <div className={styles.leftBlock}>
          <div>
            <h1 className={`${styles.title}`}>NOTT&#39;s Device Drop Campaigns</h1>
            <div className={styles.description}>
              Discover the ongoing revolution in health tracking through NOTT&#39;s Device Drop Campaigns.{" "}
              {isDesktop && <br />}These periodic initiatives are our commitment to make advanced health monitoring
              accessible to all
            </div>
            <a style={{ textDecoration: "none" }} href={ROUTERS.KYC}>
              <PrimaryButton className={styles.joinCampaign}>Join Campaigns</PrimaryButton>
            </a>
          </div>
              ...
              <div key={index} className={styles.item}>
                ...
                >
                  <div className={styles.leftQuestion}>
                    <img className={styles.leftImage} src={faq.image} alt="graphic" loading="lazy" />
                    {faq.title}
                  </div>
                  <img
                    src={openIndex === index ? "../images/minus.svg" : "../images/plus.svg"}
                    alt="Toggle Icon"
                    loading="lazy"
                  />
                </div>
